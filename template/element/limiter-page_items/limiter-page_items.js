...
class LimiterPageItems extends HTMLElement
{
	...
	{
return `\
<div class='limiter-page_items-top' style='grid-auto-rows: ${element_height};'>
	<label-half style='width: 75px;'>Page </label-half>
	<input-int id='${id}_Page' value='1' value_default='1' value_min='1' value_max='999' width_input='50px' width_button='40px'></input-int>
	<label-half style='width: 75px;'>Items </label-half>
	<input-int id='${id}_Items' value='10' value_default='10' value_min='1' value_max='${items_max}' width_input='50px' width_button='40px'></input-int>
</div>
<div class='limiter-page_items-bottom' style='grid-auto-rows: ${element_height};'>
	<label-full id='${id}_Shown' label='Shown = ' value='0 - 0' style='width: 170px;'></label-full>
	<label-full label='Count = ' value='${items_max}' style='width: 120px;'></label-full>
	<a is='href-button' id='${id}_Refresh' style='width: 130px;'>Refresh</a>
</div>`;
	}
	...
	set items_max(value) { this.setAttribute('items_max', value); }
	...
	set param(value) { this.setAttribute('param', value); }
	...
	constructor()
	{
		...
		this.node_page = document.getElementById(`${this.id}_Page`);
		this.node_items = document.getElementById(`${this.id}_Items`);
		this.node_shown = document.getElementById(`${this.id}_Shown`);
		this.node_refresh = document.getElementById(`${this.id}_Refresh`);
	...
	RefreshElement()
	{
		...
		if (null === param_items || null === param_page)
